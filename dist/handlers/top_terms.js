...
export class EBITopTermsHandler {
    async run(args) {
        ...
        const url = `https://www.ebi.ac.uk/ebisearch/ws/rest/${encodeURIComponent(domain)}/topterms/${encodeURIComponent(fieldId)}?${params.toString()}`;
        ...
        if (!Array.isArray(data.terms)) {
            throw new Error("Unexpected API response format: terms not found");
        }
        const payload = {
            domain,
            fieldId,
...
//# sourceMappingURL=top_terms.js.map