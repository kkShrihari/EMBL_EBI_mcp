...
export class EBICrossReferenceAllHandler {
    async run(args) {
        ...
        const url = `https://www.ebi.ac.uk/ebisearch/ws/rest/${encodeURIComponent(domain)}/entry/${encodeURIComponent(entryId)}/xref?${params.toString()}`;
        const res = await fetch(url);
        if (!res.ok) {
            throw new Error(`EBI cross-reference discovery failed (${res.status})`);
        }
...
//# sourceMappingURL=xref_all.js.map